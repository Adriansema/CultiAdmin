...
return [
    ...
    */
    ...
    'custom' => [
        'archivo_upload' => [
            'mimes' => 'Este tipo de archivo no se admite, solo el archivo tipo PDF.', // O si quieres que sea dinamico: 'Este tipo de archivo no se admite. Solo se permiten archivos tipo :values.'
        ],
        'password' => [
            'regex' => 'Contrasena: !Usa letras, numeros y simbolos!',
        ],
    ],
