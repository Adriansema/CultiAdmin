...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('visits', function (Blueprint $table) {
            ...
            // updated_at no esta en tu lista, si no lo necesitas, no incluyas $table->timestamps()
            // Si solo quieres created_at, debes definirlo explicitamente y no usar timestamps()
            // Si lo quieres ambos y 'created_at' tiene un default, puedes usar:
            // $table->timestamp('created_at')->useCurrent(); // Laravel 9+ mas conciso
