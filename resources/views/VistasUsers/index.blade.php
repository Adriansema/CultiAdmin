    ...
    <div class="px-6 py-4">
        <div class="inline-block px-8 py-10">
            <div class="flex items-center space-x-2">
                ...
                <h1 class="text-3xl whitespace-nowrap font-bold">Vista de Usuario</h1>
            </div>
            {!! Breadcrumbs::render('view-user.index') !!}
        </div>
        <a href="{{ route('view-user.create') }}" class="inline-block px-4 py-2 mb-4 text-white bg-blue-600 rounded">+ Nuevo
            Usuario</a>
                ...
                @foreach ($usuarios as $usuario)
                    <tr class="border-t">
                        ...
                        <td class="flex py-2 space-x-2">
                            ...
                            <a href="{{ route('view-user.historial', $usuario->id) }}"
                                class="text-purple-600">Historial</a>
                            <form action="{{ route('view-user.destroy', $usuario->id) }}" method="POST"
