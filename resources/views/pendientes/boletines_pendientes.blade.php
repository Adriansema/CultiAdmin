    ...
    <div class="container mx-auto py-6">
        ...
        <div class="w-full max-w-6xl px-6 py-1 mx-auto bg-[var(--color-Gestion)] rounded-xl">
            <div class="flex items-center justify-between">
                @include('pendientes.partials.bol-search')
                <div class="flex items-center justify-end py-4 space-x-2">
                    <x-responsive-nav-link href="{{ route('pendientes.boletines.index') }}" {{-- Asume una nueva ruta para boletines --}}
            ...
            @include('pendientes.partials.boletines')
