{{-- 
? Este codigo genera un campo de busqueda interactivo para usuarios.
? Incluye:
--}}
<div class="relative flex items-center w-full max-w-xl">
    {{-- ! Un campo de texto (<input>) para escribir la busqueda, con estilos que cambian al pasar el raton o al enfocarlo. --}}
    <input type="text" id="ProInput" placeholder="Buscar Producto..."
    ...
    <img src="{{ asset('images/search.svg') }}" id="searchIcon"
        class="w-4 h-5 absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer" alt="icono de busqueda">

    <div id="clearIconContainer" class="w-4 h-5 absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer hidden group">
        {{-- ! Un icono de "X" (Equis.svg y Equis-Hover.svg) oculto que aparece cuando el usuario empieza a escribir. Este icono, al hacer clic, permite borrar el texto del campo de busqueda y desaparece. --}}
    ...
    {{-- ? La funcionalidad es la de un componente de UI para busqueda que ofrece una experiencia visual intuitiva para buscar y borrar texto. --}}
</div>