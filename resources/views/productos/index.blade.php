    ...
    @can('crear producto')
        ...
        <div class="w-full mx-auto bg-[var(--color-Gestion)] rounded-2xl mb-8 max-w-7xl
            ...
            <div class="flex flex-col justify-between gap-4 mb-4 md:flex-row md:items-center">
                ...
                {{-- Grupo de botones --}}
                <div class="flex flex-col justify-end w-full py-2 space-y-2 sm:flex-row sm:items-center sm:py-5 sm:space-y-0 sm:space-x-2">
            ...
            @if ($productos->total() > 0 && $productos->hasPages())
                <div class="p-2 mt-4 bg-white shadow-sm rounded-b-xl">
