{{-- resources/views/productos/partials/search.blade.php --}}

<div class="relative flex items-center w-full max-w-xl">
    <input type="text"
           id="SearchLive" {{-- CRUCIAL: Este ID es usado en JS --}}
           name="q"
    ...
    <div id="clearIconContainer" {{-- CRUCIAL: Este ID es usado en JS --}}
         class="w-4 h-6 absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer group {{ request('q') ? '' : 'hidden' }}">
