<div id="modal-boletines-{{ $boletin->id }}" class="hidden fixed inset-0 z-50 items-center justify-center bg-black/50">
    <div class="w-full max-w-md p-6 bg-white rounded-lg shadow-lg">
        ...
        <form action="{{ route('boletines.destroy', $boletin) }}" method="POST">
            ...
            <div class="flex items-center justify-between">
                <button type="button" onclick="cerrarModal('boletines', '{{ $boletin->id }}')"
