    ...
    <div class="flex flex-col sm:flex-row items-center justify-between mb-4 flex-wrap"> 
        ...
        <div class="flex items-center justify-center sm:justify-end flex-nowrap gap-2 py-4 sm:py-0">
            ...
            <button type="button" id="filterBtn"
                class="inline-flex group items-center justify-center px-4 py-3 space-x-2 space-x-reverse transition-all duration-300 ease-in-out bg-[var(--color-Gestion)] border border-[var(--color-ajustes)] hover:border-[#39A900] rounded-full whitespace-nowrap"> 
