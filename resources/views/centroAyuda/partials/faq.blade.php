<div class="mt-4 space-y-4 accordion" id="faqAccordion faq-list">
    ...
    <p class="mb-6">
        Bienvenido a la guía de usuario. Aquí te explicamos paso a paso como sacar el máximo provecho de cada sección de nuestra plataforma.
                ...
                <ol class="pl-5 mt-2 space-y-3 list-decimal">
                    <li>
                        ...
                        <ul class="pl-5 mt-1 space-y-1 list-disc">
                            <li>Dirígete a <b>Gestión de usuarios > Lista de usuarios</b>.</li>
                    ...
                    <li>
                        ...
                        <ul class="pl-5 mt-1 space-y-1 list-disc">
                            ...
                            <li><b>Documento</b> (numero de identificación)</li>
                        </ul>
                    ...
                    <li>
                        ...
                        <p class="mt-1">Aquí definiras el nivel de acceso y las funcionalidades del <b>nuevo
                    ...
                    <li>
                        ...
                        <ul class="pl-5 mt-1 space-y-1 list-disc">
                            ...
                            <li>Aparecera un <b>modal de confirmación</b> con un resumen de todos los datos ingresados y
        ...
        <div class="faq-item question-item" data-question="roles-usuarios">
            <div class="p-4 bg-gray-200 rounded-lg">
                ...
                <ul class="pl-5 mt-2 space-y-1 list-disc">
                    <li>Dirígete a <b>Gestión de usuarios > Lista de usuarios</b>.</li>
                    <li>Busca al <b>usuario</b> deseado en la lista y haz clic en el ícono <b>"Editar" que aparece del lado del rol</b> asociado a su
                        perfil.</li>
                ...
                <b>usuarios</b>, puedes encontrar mas información
