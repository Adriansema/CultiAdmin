...
<div class="w-full px-4 mb-8 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col mb-4 md:flex-row md:items-center md:justify-between md:mb-0">
        ...
        <div class="flex flex-col items-stretch justify-end w-full py-4 space-y-2 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-2 md:w-auto">
            ...
            {{-- Form Exportar Csv --}}
            <form method="GET" action="{{ route('noticias.exportarCsv') }}" id="exportCsvForm" class="w-full sm:w-auto">
