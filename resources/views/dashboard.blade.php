            ...
            {{-- <div id="boletines-novedades" class="max-w-full p-4 bg-white rounded-lg shadow">
                ...
                <ul>
                    ...
                    <li class="pb-2 mb-4 border-b border-gray-200">
                        <div class="flex items-center justify-between cursor-pointer boletin-header"
                            data-id="{{ $boletin->id }}">
                            <div>
                                <strong>{{ $boletin->nombre }}</strong>
                                <small class="ml-2 text-gray-400">{{ $boletin->created_at->format('d M Y') }}</small>
