<div id="noticia-modal-exito" class="hidden fixed inset-0 z-50 items-center justify-center bg-black bg-opacity-50">
    <div id="noticia-modal-contenido" class="bg-white rounded-lg shadow-xl p-8 max-w-sm w-full mx-4 opacity-0">
