                        ...
                        @foreach ($usuarios as $usuario)
                            <tr class="bg-white hover:bg-gray-300">
                                <td class="px-6 py-4 flex items-center group relative">
                                    ...
                                    <img src="{{ asset('images/lapiz.svg') }}" class="w-4 h-4 absolute left-[calc(60%+4px)] top-1/2 -translate-y-1/2 
                                ...
                                <td class="px-6 py-4">
                                    <form action="{{ route('usuarios.toggle', $usuario) }}" method="POST" class="inline-block">
                                        ...
                                        <button type="submit"
                                            ...
                                            inline-flex items-center justify-center"> {{-- Usamos inline-flex para el botón --}}
                                            ...
                                            <span class="flex items-center space-x-2 transition-opacity duration-300
                                                        ...
                                                        group-hover:opacity-0 pointer-events-none"> {{-- Añadir pointer-events-none aquí también --}}
