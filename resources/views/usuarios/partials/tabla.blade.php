         ...
         <thead class="bg-[var(--color-tabla)]">
             <tr>
                 ...
                 <th class="px-4 py-2 font-bold text-left text-gray-600">
                     <div class="flex items-center">
                         <div class="flex flex-wrap items-center justify-between flex-grow">
                             <span class="whitespace-nowrap flex-shrink-0">Rol</span>
                 ...
                 <th class="px-4 py-2 font-bold text-left text-gray-600">
                     <div class="flex items-center">
                         <div class="flex flex-wrap items-center justify-between flex-grow">
                             <span class="whitespace-nowrap flex-shrink-0">Correo</span>
                             <div class="flex flex-col ml-2 flex-shrink-0">
                                 <button type="button" class="sort-icon-btn group whitespace-nowrap"
                     ...
                     <tr class="bg-white hover:bg-gray-200">
                             ...
                             <div class="flex flex-wrap items-center">
                                 ...
                                 @can('editar usuario')
                                     @if ($canEditTargetUser && $loggedInUser)
                                         ...
                                         <button type="button" class="ml-2 edit-user-button flex-shrink-0"
                                     ...
                                     @else
                                         ...
                                         <span class="ml-2 cursor-not-allowed flex-shrink-0">
                         ...
                         <td class="px-4 py-3">
                             ...
                             @if ($usuario->id !== Auth::id())
                                 ...
                                 @if ($canShowToggleButton)
                                     <form action="{{ route('usuarios.toggle', $usuario) }}" method="POST"
                                         ...
                                         <button type="submit"
                                             class="group relative px-6 py-2 text-sm rounded-lg text-[var(--color-textAct)] transition-colors duration-300
                                             ...
                                             <span
                                                 class="flex items-center justify-center space-x-2 transition-opacity duration-300
                                 ...
                                 @else
                                     ...
                                     <span
                                         class="px-6 py-2 text-sm rounded-lg flex-shrink-0
                                            ...
                                            inline-flex items-center justify-center space-x-2 cursor-not-allowed">
                                         <span>
                                             @if ($usuario->id === Auth::id())
                             ...
                             @else
                                 ...
                                 <span
                                     class="px-5 py-2 text-sm rounded-lg flex-shrink-0
                                            bg-[var(--color-estasAct)] text-[var(--color-estaActex)]
                                            inline-flex items-center justify-center space-x-2 cursor-not-allowed">
                                     <span>{{ $usuario->estado === 'activo' ? 'Estas activo' : 'Estas inactivo' }}</span>
                                     <span {{-- class="w-3 h-3 rounded-full {{ $usuario->estado === 'activo' ? '' : '' }}"> --}}</span>
                                     </span>
                             @endif
                         </td>
                     </tr>
