<div id="appNotificationModal"
    ...
    <div class="relative bg-white rounded-lg shadow-xl p-6 w-full max-w-sm mx-auto my-8">
        <div class="flex items-center justify-center flex-col">
            {{-- Icono (se actualizara con JS) --}}
            <div id="appNotificationIconContainer" class="mb-4">
                {{-- SVG de exito (por defecto, se puede cambiar a error con JS) --}}
                <svg id="appNotificationSuccessIcon" class="w-16 h-16 text-green-500" fill="none" stroke="currentColor" 
                ...
                <svg id="appNotificationErrorIcon" class="w-16 h-16 text-red-500 hidden" fill="none" stroke="currentColor" 
                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                d="M10 14l2-2m0 0l2-2m-2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            </div>
            {{-- Mensaje --}}
