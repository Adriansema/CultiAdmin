...
@section('content')
    ...
    {{-- Protección general para ver la lista de usuarios --}}
        ...
        <div class="w-full max-w-6xl px-6 py-1 mx-auto bg-[var(--color-Gestion)] rounded-xl">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-end py-4 space-x-2">
                    ...
                    {{-- Botón para Exportar CSV: Visible solo si el usuario puede 'exportar usuarios' --}}
                    ...
                    {{-- Botón para Crear Nuevo Usuario: Visible solo si el usuario puede 'crear usuarios' --}}
                    {{-- @can('create', App\Models\User::class)
                        <x-responsive-nav-link href="{{ route('usuarios.create') }}" {{-- ! Nuevo Usuario: Un botón para crear un nuevo usuario, que tiene un icono y un cambio de color al pasar el ratón. --
    ...
    @endcan
    {{-- Mensaje si el usuario no tiene permiso para ver la lista de usuarios --}}
