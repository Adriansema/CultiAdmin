            ...
            <div class="flex items-center justify-end py-4 space-x-2">
                ...
                <form method="GET" action="{{ route('usuarios.exportar') }}">
                    <x-responsive-nav-link href="#" onclick="this.closest('form').submit(); return false;"
                        ...
                        <img src="{{ asset('images/export.svg') }}" class="w-3 h-4 relative inset-0 block group-hover:hidden" alt="Icono Exportar CSV">
                        <img src="{{ asset('images/Export-hover.svg') }}" class="w-3 h-4 relative inset-0 hidden group-hover:block" alt="Icono Exportar CSV">
                    </x-responsive-nav-link>
                </form>
