document.addEventListener('DOMContentLoaded', () => {
    ...
    // En tu Blade, el <ul> tiene id="courseList", lo renombro a userList
    // o puedes usar el que ya tienes.
    ...
    // Lógica para realizar la petición AJAX
    ...
    const renderTableRows = (users, query = '') => { // <--- Recibe el query /nuevo
        ...
        users.forEach(user => {
            ...
            //con nregilla en las letras seleccionadas
            let rowHtml = `
